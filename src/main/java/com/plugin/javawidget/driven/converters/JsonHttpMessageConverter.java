...
public class JsonHttpMessageConverter extends AbstractGenericHttpMessageConverter<Object> {
	...
	private class json extends Json {
		@Override
		protected void toJson(Object src, Type typeOfSrc, Appendable writer) throws JsonIOException {
			super.toJson(src, typeOfSrc, writer);
		}

		@Override
		protected void toJson(Object src, Appendable writer) throws JsonIOException {
			super.toJson(src, writer);
		}
	}
	...
	protected void writeInternal(Object o, Type type, HttpOutputMessage httpOutputMessage) throws IOException, HttpMessageNotWritableException {
		...
		try {
			if (type != null) {
				new json().toJson(o, type, writer);
			} else {
				new json().toJson(o, writer);
			}
		} catch (Exception e) {
